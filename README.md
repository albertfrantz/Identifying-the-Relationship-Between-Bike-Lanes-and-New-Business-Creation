...
Bachelor degree or higher was almost significant at the 5% level (p value: .0597). Looking at this result, once again found in table 4, we can see that as education increased in New York City neighborhoods so too did business applications. We found that for every percent increase in the neighborhood population that held a bachelor degree or higher, the number of business applications increased by .202. This result seems to counteract previous research that has found that college graduates are less likely to start a new business. Research outside of the United States, in England, has found that only 4.7% of recent graduates are self-employed compared to the 8.7% of the general population (HESA, 2017). 
